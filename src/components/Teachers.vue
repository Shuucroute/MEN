...
import JasonImg from '/src/assets/img/prof/Jason.png'
import IsmaImg from '/src/assets/img/prof/Isma.png'
import ThomasImg from '/src/assets/img/prof/Thomas.png'
import LaurentImg from '/src/assets/img/prof/Laurent.png'
